...
const useConversationList = createUseFetchModelListInfiniteHook<ConversationType, { branchId: number }>({
    url: "/api/ai/model/Partition/list",
    schema: ConversationSchema
})


const useConversation = createUseFetchModelHook<ConversationType, { branchId: number }>({
    url: "/api/ai/model/Partition/record",
    schema: ConversationSchema
})

const useCreateConversation = createUseCreateModelHook<ConversationType, ConversationPayloadType, { branchId: number }>({
    url: "/api/ai/model/Partition/create",
    schema: ConversationSchema
})

const useUpdateConversation = createUseUpdateModelHook<ConversationType, ConversationPayloadType, { branchId: number }>({
