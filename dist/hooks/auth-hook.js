...
export const isGuestTokenIsVaild = async (token) => {
...
export function useEnsureGuestToken(status) {
    ...
    useEffect(() => {
        ...
        const checkGuestToken = async () => {
            ...
            if (!guestToken) {
                ...
                if (window.__guest_token_requested)
                    return;
                window.__guest_token_requested = true;
                ...
                window.__guest_token_requested = false;
            }
        };
