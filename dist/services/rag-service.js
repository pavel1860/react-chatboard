...
export function useRagNamespacesEndpoint() {
...
export async function getRagDocumentsApi(namespace, page, pageSize = 10, sortField = undefined, sortOrder = undefined) {
...
export function useRagDocumentsEndpoint(namespace, pageSize = 10, pageIndex = 0) {
...
export async function addDocumentEndpoint(namespace, input, output, id) {
