import { TurnCtxSchema, TurnSchema as BaseTurnSchema, TurnPayloadSchema as BaseTurnPayloadSchema, } from "../components/chat/schema";
...
const useVersionTurnList = createUseFetchModelListInfiniteHook({
...
const useTurnMessages = createUseFetchModelListInfiniteHook({
    url: "/api/ai/model/Turn/messages",
    schema: TurnSchema
});
const useTurnBlocks = createUseFetchModelListInfiniteHook({
