...
export function Divider() {
    return _jsx("div", { className: "mx-1 h-6 w-px bg-gray-400" });
}
export function Placeholder({ text, offset }) {
    ...
    return (_jsx("div", { 
        ...
        className: `pointer-events-none absolute left-2.5 ${top} inline-block select-none overflow-hidden text-base font-normal text-gray-400`, children: text || "Write somthing..." }));
}
