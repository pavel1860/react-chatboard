...
export const BlockListSchema = z.lazy(() => z.object({
    Type: z.literal("BlockList").optional(),
    index: z.number().optional(),
    children: z.array(z.union([BlockSchema, BlockSentSchema, BlockChunkSchema])),
...
export const SpanEventSchema = z.lazy(() => z.object({
    id: z.number(),
...
const TurnSchema = z.object({
    id: z.number(),
    createdAt: z.preprocess((val) => typeof val === "string" ? new Date(val) : val, z.date()),
    endedAt: z.preprocess((val) => typeof val === "string" ? new Date(val) : val, z.date()).nullable(),
